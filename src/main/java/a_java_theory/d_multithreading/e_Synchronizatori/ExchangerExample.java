package a_java_theory.d_multithreading.e_Synchronizatori;

import java.util.concurrent.Exchanger;

// Exchanger (Обменник)
// Синхронизатор, который позволяет двум потокам обмениваться данными.
// Другими словами, это точка встречи двух потоков, где они могут обменяться объектами.

// Полезно в сценариях, когда два потока работают вместе и должны обмениваться данными в определенные моменты времени.
